...
[hist, norHist, cdf, levels] = computeHistogram(interpoliraj_nictega);
histo_obmocja = displayHistogram(hist,levels,'histogram');
saveas(histo_obmocja, 'histogram_obmocja.png')
...
saveas(prikaz_nictega, 'prikaz_nictega.png')
...
saveas(prikaz_histo_nictega, 'histogram_nictega.png')
...
saveas(prikaz_prvega, 'prikaz_prvega.png')

[hist_prvega, norHist_prvega, cdf_prvega, levels_prvega] = computeHistogram(interpoliraj_nictega);
prikaz_histo_prvega = displayHistogram(hist_prvega,levels_prvega,'histogram interpolacije prvega reda');
saveas(prikaz_histo_prvega, 'histogram_prvega.png')
...
saveas(pravilni_prikaz_nictega, 'popravljen_prikaz_nictega.png')
saveas(pravilni_prikaz_prvega, 'popravljen_prikaz_prvega.png')
